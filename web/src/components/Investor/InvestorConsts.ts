export const upIconClassName =
  'flex h-6 lg:h-7 w-6 lg:w-7 fill-primary-d1 dark:fill-primary-l1 cursor-pointer'

export const profileUpIconClassName =
  'flex h-7 lg:h-8 w-7 lg:w-8 fill-primary-d1 dark:fill-primary-l1 cursor-pointer'

export const menuIconClassName =
  'flex h-6 lg:h-7 w-6 lg:w-7 fill-black hover:fill-primary-d1 dark:fill-white dark:hover:fill-primary-l1 cursor-pointer'
...
export const profileMenuSelectedItemClassName =
  'flex w-full items-center justify-start gap-2 rounded bg-primary-d1 p-2 dark:bg-primary-l1 lg:p-3 lg:gap-3'
