...
const StartupOnboardingTimeline = (props: OnboardingTimelineProps) => {
  return (
    <div
      ...
      } right-0 top-0 min-w-[300px] flex-col gap-2 overflow-hidden rounded bg-white-d1 p-3 shadow-md dark:bg-black-l2/95 lg:static lg:flex lg:h-full lg:w-1/3 lg:border-l-2  lg:border-l-white-d2 lg:bg-transparent lg:py-1 lg:pl-3 lg:pr-0 lg:shadow-none dark:lg:border-l-black-l2 dark:lg:bg-transparent`}
    >
      <TertiaryTextLabel
