...
const LoginPageLayout = ({ children }: LoginPageLayoutProps) => {
  return (
    <div className="h-screen bg-white px-5 dark:bg-black-l1   lg:px-8 ">
      <div className="flex h-full flex-col gap-4 lg:gap-5 xl:mx-auto xl:max-w-screen-xl ">
        <LoginHeader />
        {children}
      </div>
    </div>
...
const LoginHeader = () => {
  return (
    <div className="flex items-center justify-between py-2 lg:py-3">
      <Logo className="h-6 w-10 content-start lg:h-8 lg:w-12" />
